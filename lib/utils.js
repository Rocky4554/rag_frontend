...
const FRIENDLY_MESSAGES = {
  ...
  // Mic
  "microphone access denied": "Microphone access was denied. On Android, close all floating bubbles (Messenger, etc.), screen recorders, or blue light filters and try again.",
  "notallowederror": "Access was denied. On Android, close all floating bubbles (Messenger, etc.), screen recorders, or blue light filters and try again.",
  // Rate limit
...
export async function requestMicrophonePermission() {
  try {
    // Request permission directly using getUserMedia for the cleanest possible trigger
    ...
    if (err.name === "NotAllowedError") {
      throw new Error(
        "Microphone access denied. On Android, close all floating bubbles (Messenger, etc.), screen recorders, or blue light filters and try again."
      );
    }
