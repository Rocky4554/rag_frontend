...
api.interceptors.response.use(
  ...
  async (error) => {
    ...
    // Skip auto-refresh/redirect for auth endpoints (login, signup, logout, etc.) but allow profile to refresh
    const isAuthRequest = originalRequest.url?.includes('/api/auth/') && !originalRequest.url?.includes('/api/auth/profile');
